...
{	
	...
	function updateNumberOfSpheres ()
	{
		...
		const texture = textureLoader.load('https://upload.wikimedia.org/wikipedia/commons/7/7c/Earth_texture.jpg');
		...
		for (let i = 0; i < wins.length; i++)
		{
			...
			let s = 100 + i * 50;
			let sphere = new t.Mesh(new t.SphereGeometry(s, 32, 32), new t.MeshStandardMaterial({map: texture}));
